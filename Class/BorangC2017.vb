...
Public Class BorangC2017
    'Dim Total As Double
    Private dr As OleDbDataReader
    Private dr2 As OleDbDataReader
    Private dr3 As OleDbDataReader
    Private dr4 As OleDbDataReader
    Private dr5 As OleDbDataReader
    ...
    Private RefNo As String = Nothing
    Private YARef As String = Nothing
...
#Region "Pages Function"
    ...
    Public Sub Page1()
        ...
        Try
            ...
            ' part 1
            RefNo = Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value)
            YARef = Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value)

            cSQL = "Select TP_COM_NAME, TP_REF_NO, TP_EMPLOYER_NO, TP_RESIDENCE, TP_COUNTRY, TP_ROC_NO, TP_ACC_PERIOD_FR, TP_ACC_PERIOD_TO, TP_BASIS_PERIOD_FR, TP_BASIS_PERIOD_TO, TP_EFILING, TP_PUBLIC_ORDER, TP_OPN_OPERATION, TP_COM_STS,TP_CARRYETRANDING, TP_SECTION_127_1,TP_SECTION_127_2,TP_SECTION_127_3, TP_ROYALCLAIM, TP_GOODSERVICETAXREGISTRAION,TP_BUILDINGINDUSTRY " _
                  & " from TAXP_PROFILE" _
            ...
            If dr.Read() Then
                ...
                If IsDBNull(dr("TP_RESIDENCE")) = False Then
                    If dr("TP_RESIDENCE") = "1" Then
                        pdfFormFields.SetField(pdfFieldFullPath + "IV_1", "1")
                        ' pdfFormFields.SetField(pdfFieldFullPath + "IV_2", "")
                    Else
                        pdfFormFields.SetField(pdfFieldFullPath + "IV_1", "2")
                ...
                If IsDBNull(dr("TP_CARRYETRANDING")) = False AndAlso dr("TP_CARRYETRANDING") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVII", "1")
                    '  pdfFormFields.SetField(pdfFieldFullPath + "XVII", "")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVII", "2")
                End If

                If IsDBNull(dr("TP_SECTION_127_1")) = False AndAlso dr("TP_SECTION_127_1") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_1", "X")
                    ' pdfFormFields.SetField(pdfFieldFullPath + "XVI_1", "")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_1", "")
                End If

                If IsDBNull(dr("TP_SECTION_127_2")) = False AndAlso dr("TP_SECTION_127_2") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_2", "X")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_2", "")
                End If

                If IsDBNull(dr("TP_SECTION_127_3")) = False AndAlso dr("TP_SECTION_127_3") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_3", "X")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI_3", "")
                End If

                If IsDBNull(dr("TP_ROYALCLAIM")) = False AndAlso dr("TP_ROYALCLAIM") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVIII", "1")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVIII", "2")
                End If

                If IsDBNull(dr("TP_GOODSERVICETAXREGISTRAION")) = False Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XIX", dr("TP_GOODSERVICETAXREGISTRAION"))
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XIX", "")
                End If

                If IsDBNull(dr("TP_GOODSERVICETAXREGISTRAION")) = False Then
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI", dr("TP_GOODSERVICETAXREGISTRAION"))
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "XVI", "")
                End If

                If IsDBNull(dr("TP_BUILDINGINDUSTRY")) = False AndAlso dr("TP_BUILDINGINDUSTRY") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "J_1", "1")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "J_1", "2")
                End If
                'azham 24-jun-2017

                If dr("TP_PUBLIC_ORDER") = "0" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "IX_1", "1")
                    pdfFormFields.SetField(pdfFieldFullPath + "IX_2", "2")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "IX_1", "1")
                    pdfFormFields.SetField(pdfFieldFullPath + "IX_2", "2")
                End If
                ...
                If frmDownloadDetails.chkKeepRecord.Checked = True Then
                    ...
                    pdfFormFields.SetField(pdfFieldFullPath + "X_1", "1")
                    ' pdfFormFields.SetField(pdfFieldFullPath + "X_2", "2")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "X_1", "2")
                    '  pdfFormFields.SetField(pdfFieldFullPath + "X_2", "2")
                End If
            ...
            Else
                ...
                ReDim strArray(10)
                'MsgBox("AZHAM " & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value))
                cSQL = "Select BC_CODE" _
                        & " from BUSINESS_SOURCE" _
        ...
        Try
            ...
            If dr.Read() Then
                If dr("PL_S60F") = "Y" Then
                    ...
                    If dr.Read() Then
                        ...
                        pdfFormFields.SetField(pdfFieldFullPath + "C2017_4", "0")

                        If IsDBNull(dr("IH_CHARGEABLE_IN")) = False Then
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_5", CDbl(dr("IH_CHARGEABLE_IN")).ToString.Replace(",", ""))
                        Else
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_5", "0")
                        End If
                ...
                Else
                    ...
                    cSQL = "SELECT TC_STAT_DIVIDEND, TC_TP_PIONEER_CHARGE, TC_TP_CHARGEABLE, TC_TP_FOREIGN_CHARGE,TC_EXEMPTIONCAL,TC_EXEMPTIONLESS" _
                            & " FROM TAX_COMPUTATION" _
                            & " WHERE [TC_REF_NO]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) _
                            & "' AND [TC_YA]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value) & "'" _
                            & " ORDER BY [TC_BUSINESS]"
                    ...
                    If dr.Read() Then
                        ...
                        If IsDBNull(dr("TC_TP_CHARGEABLE")) = False Then
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_4", CDbl(dr("TC_EXEMPTIONCAL")).ToString.Replace(",", ""))
                        Else
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_4", "0")
                        End If

                        If IsDBNull(dr("TC_TP_CHARGEABLE")) = False Then
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_5", CDbl(dr("TC_EXEMPTIONLESS")).ToString.Replace(",", ""))
                        Else
                            pdfFormFields.SetField(pdfFieldFullPath + "C2017_5", "0")
                        End If
                        ...
                        ' C2017_5 +A39
                        If IsDBNull(dr("TC_TP_CHARGEABLE")) = False Then
                            pdfFormFields.SetField("B1", CDbl(dr("TC_EXEMPTIONLESS")) + CDbl(dr("TC_TP_FOREIGN_CHARGE")).ToString.Replace(",", ""))
                        Else
                            pdfFormFields.SetField(pdfFieldFullPath + "B1", "0")
                        End If
                    Else
            ...
            Else
                ...
                cSQL = "Select TC_TP_APP_CHARGEABLE1, TC_TP_APP_CHARGEABLE2, TC_TP_APP_CHARGEABLE3, TC_TP_APP_CHARGEABLE4, TC_TP_APP_CHARGEABLE4A, TC_TP_APP_CHARGEABLE5, TC_TP_APP_CHARGEABLE6, TC_TP_RATE1, TC_TP_RATE2, TC_TP_RATE3, TC_TP_RATE4, TC_TP_RATE4A, TC_TP_RATE5, TC_TP_RATE6," _
                        ...
                        & " TC_BUSINESS,TC_TP_INSTALL_107C,TC_TP_INSTALL_107A" _
                        & " FROM TAX_COMPUTATION" _
                        & " WHERE [TC_REF_NO] = '" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) & "' And TC_YA ='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value) & "'" _
                        & " Order by TC_BUSINESS"
                dr = DataHandler.GetDataReader(cSQL, Conn)
                ...
                pdfFormFields.SetField(pdfFieldFullPath2 + "C2017_1", Replace((Convert.ToDouble(dr("TC_TP_INSTALL_107C")).ToString("0.00")), ".", "").Replace(",", "").Replace("-", ""))
                pdfFormFields.SetField(pdfFieldFullPath2 + "C2017_2", Replace((Convert.ToDouble(dr("TC_TP_INSTALL_107A")).ToString("0.00")), ".", "").Replace(",", "").Replace("-", ""))
    ...
    Public Sub Page5()
        ...
        Try
            ...
            ' E12
            cSQL = "Select Sum(TC_CB_CA_DISALLOW)" _
                   & " from TAX_COMPUTATION" _
         ...
         & "' And EA_YA ='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(2).Value) & "'"
            ...
            If dr.Read() Then
                If Trim(dr("DP_DISPOSAL").ToString) = "Yes" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "K1_1", "1")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "K1_1", "2")
                End If

                If dr("DP_DECLARE").ToString = "Yes" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "K2_1", "1")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "K2_1", "2")
                End If
            ...
            If dr.Read() Then
                ...
                'endweihong
                cSQL = "SELECT SUM(ED_AMOUNT) FROM EXEMPT_DIVIDEND WHERE ED_KEY = " & strPLKey
                dr2 = DataHandler.GetDataReader(cSQL, Conn)
    ...
    Public Sub Page11()
        ...
        & " TP_ALT_POSTCODE, TP_ALT_CITY, TP_ALT_STATE, TP_BANK, TP_BANK_ACC, TP_RECORD_KEPT, TP_BLOG,TP_STS_OTHER" _
        & " FROM [TAXP_PROFILE]" _
        & " WHERE [TP_REF_NO]='" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) & "'"
            dr = DataHandler.GetDataReader(cSQL, Conn)
            If dr.Read() Then
    ...
    Public Sub Page12()
        ...
        Try
            ...
            & " DIR_EQUITY, DIR_SALARY, DIR_ALLOW, DIR_LOAN_TO, DIR_LOAN_FROM,DIR_DATE_OF_BIRTH" _
            ...
            Do While dr.Read()
                ...
                'azham 13-jun-2017
                If IsDBNull(dr("DIR_DATE_OF_BIRTH")) = False AndAlso IsDate(dr("DIR_DATE_OF_BIRTH")) Then
                    pdfFormFields.SetField(pdfFieldFullPath + "P21_" + strIndex, Mid(Format(dr("DIR_DATE_OF_BIRTH"), "ddMMyyyy"), 1, 8))
                    '  pdfFormFields.SetField(pdfFieldFullPath + "P21_" + strIndex, "00000000")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "P21_" + strIndex, "")
                End If
                'azham 13-jun-2017
    ...
    Public Sub Page13()
        ...
        Try
            ' === Q1 - Q6 ===
            cSQL = "SELECT SHAREHOLDERS_PROFILE.SH_NAME, SHAREHOLDERS_PROFILE.SH_IC, SHAREHOLDERS_PROFILE.SH_COUNTRY, SHAREHOLDERS_PROFILE.SH_SHARE, SHAREHOLDERS_PROFILE.SH_PAR_VALUE, BALANCE_SHEET.BS_CAPITAL, SHAREHOLDERS_PROFILE.SH_CHECK, SHAREHOLDERS_PROFILE.SH_SHAREP, SHAREHOLDERS_PROFILE.SH_DATE_OF_BIRTH" _
            ...
            Do While dr.Read()
                If intIndex <= 5 Then
                    ...
                    If IsDBNull(dr("SH_DATE_OF_BIRTH")) = False Then
                        'pdfFormFields.SetField(pdfFieldFullPath + "Q" + intIndex.ToString + "_6", dr("SH_DATE_OF_BIRTH"))
                        pdfFormFields.SetField(pdfFieldFullPath + "Q" + intIndex.ToString + "_6", Mid(Format(dr("SH_DATE_OF_BIRTH"), "ddMMyyyy"), 1, 8))
                    Else
                        pdfFormFields.SetField(pdfFieldFullPath + "Q" + intIndex.ToString + "_6", "")
                    End If
                End If
            Loop
    ...
    Public Sub Page14()
        ...
        Try
            ...
            'simkh 2017 su8.1
            cSQL = "SELECT TP_ULT_COMPANY, TP_ULT_COUNTRY_CODE, TP_IMD_COMPANY,TP_IMD_COUNTRY_CODE,TP_LABUAN_INCOME_TAX,TP_LABUAN_REG,TP_LABUAN_NAME,TP_LABUAN_STATUS" _
            & " FROM [TAXP_PROFILE]" _
            & " where TP_REF_NO = '" & Trim(frmDownloadMainMenu.dgdDownload.SelectedRows.Item(0).Cells(1).Value) & "'"
            dr = DataHandler.GetDataReader(cSQL, Conn)
            ...
            If dr.Read() Then
                ...
                If IsDBNull(dr("TP_LABUAN_STATUS")) = False AndAlso dr("TP_LABUAN_STATUS") = "1" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "R6_1", "X")
                    pdfFormFields.SetField(pdfFieldFullPath + "R6_2", "")
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "R6_1", "")
                    pdfFormFields.SetField(pdfFieldFullPath + "R6_2", "X")
                End If

                If IsDBNull(dr("TP_LABUAN_NAME")) = False Then
                    If Len(dr("TP_LABUAN_NAME")) > 28 Then
                        CutLine(dr("TP_LABUAN_NAME").ToString.ToUpper(), 28)
                        pdfFormFields.SetField(pdfFieldFullPath + "R6a_1", strCropped)
                        pdfFormFields.SetField(pdfFieldFullPath + "R6a_2", Mid(LTrim(strRemainder), 1, 28))
                    Else
                        pdfFormFields.SetField(pdfFieldFullPath + "R6a_1", dr("TP_LABUAN_NAME")).ToString.ToUpper()
                        pdfFormFields.SetField(pdfFieldFullPath + "R6a_2", "")
                    End If
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "R6a_1", space(28))
                    pdfFormFields.SetField(pdfFieldFullPath + "R6a_2", space(28))
                End If

                If IsDBNull(dr("TP_LABUAN_REG")) = False AndAlso dr("TP_LABUAN_REG") <> "" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "R6b", dr("TP_LABUAN_REG"))
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "R6b", "")
                End If

                If IsDBNull(dr("TP_LABUAN_INCOME_TAX")) = False AndAlso dr("TP_LABUAN_INCOME_TAX") <> "" Then
                    pdfFormFields.SetField(pdfFieldFullPath + "R6c", dr("TP_LABUAN_INCOME_TAX"))
                Else
                    pdfFormFields.SetField(pdfFieldFullPath + "R6c", "")
                End If

                '=============================================================================
                'azham = 28-jan-2017 CLOSE
                '=============================================================================
            End If
            'simkh end
    ...
    Public Sub Page15()
        ...
        Try
            ...
            dr = DataHandler.GetDataReader(cSQL, Conn, ErrorLog)
        ...
        Catch ex As Exception
            ...
            MsgBox(ErrorLog, MsgBoxStyle.Critical, "Caution")
            pdfStamper.Close()
        End Try
    End Sub
    ...
    Public Sub Slip()
        ...
        Try
            ...
            If dr IsNot Nothing Then
                ...
                End If
            Else
                pdfFormFields.SetField(pdfFieldFullPath + "Slip_R_2", "   ")
            End If
...
#End Region
    ...
    Public Function L8Calculation() As Double
        ...
        If dr3.Read() Then
            cSQL = "SELECT SUM(cdbl(PLFS_AMOUNT)) FROM [PLFST_SALES] WHERE [PLFS_KEY] = " & dr3("PL_KEY") _
            ...
            Else
                odSales = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(PLFOS_AMOUNT)) FROM [PLFST_OPENSTOCK] WHERE [PLFOS_KEY] = " _
            ...
            Else
                odOs = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(PLFPUR_AMOUNT)) FROM [PLFST_PURCHASE] WHERE [PLFPUR_KEY] = " _
            ...
            Else
                odPur = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(EXDEP_AMOUNT)) FROM [EXPENSES_DEPRECIATION] WHERE [EXDEP_KEY] = " _
            ...
            Else
                odDep = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(EXA_AMOUNT)) FROM [EXPENSES_ALLOW] WHERE [EXA_KEY] = " _
            ...
            Else
                odA = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(EXNA_AMOUNT)) FROM [EXPENSES_NONALLOW] WHERE [EXNA_KEY] = " _
            ...
            Else
                odNA = 0.0
            End If
            cSQL = "SELECT SUM(cdbl(PLFCS_AMOUNT)) FROM [PLFST_CLOSESTOCK] WHERE [PLFCS_KEY] = " _
    ...
    Public Sub L8GetBSCode()
        ...
        dr2 = DataHandler.GetDataReader(cSQL, Conn)
        If dr2.Read Then
            cSQL = "SELECT SUM(cdbl(PLFOS_AMOUNT)) FROM [PLFST_OPENSTOCK] WHERE [PLFOS_KEY] = " & dr3("PL_KEY") _
            & " AND [PLFOS_SOURCENO] = " & dr3("PL_MAINBUZ") & ""
            dr4 = DataHandler.GetDataReader(cSQL, Conn)
            If dr4.Read Then
        ...
        dr2 = DataHandler.GetDataReader(cSQL, Conn)
        If dr2.Read Then
            cSQL = "SELECT SUM(cdbl(PLFPUR_AMOUNT)) FROM [PLFST_PURCHASE] WHERE [PLFPUR_KEY] = " & dr3("PL_KEY") _
            & " AND [PLFPUR_SOURCENO] =  " & dr3("PL_MAINBUZ") & ""
            dr4 = DataHandler.GetDataReader(cSQL, Conn)
            If dr4.Read Then
        ...
        dr2 = DataHandler.GetDataReader(cSQL, Conn)
        If dr2.Read Then
            cSQL = "SELECT SUM(cdbl(EXDEP_AMOUNT)) FROM [EXPENSES_DEPRECIATION] WHERE [EXDEP_KEY] = " & dr3("PL_KEY") _
            & " AND [EXDEP_SOURCENO] =  " & dr3("PL_MAINBUZ") & ""
            dr4 = DataHandler.GetDataReader(cSQL, Conn)
            If dr4.Read Then
        ...
        dr2 = DataHandler.GetDataReader(cSQL, Conn)
        If dr2.Read Then
            cSQL = "SELECT SUM(cdbl(EXA_AMOUNT)) FROM [EXPENSES_ALLOW] WHERE [EXA_KEY] = " & dr3("PL_KEY") _
            & " AND [EXA_SOURCENO] =  " & dr3("PL_MAINBUZ") & ""
            dr4 = DataHandler.GetDataReader(cSQL, Conn)
            If dr4.Read Then
